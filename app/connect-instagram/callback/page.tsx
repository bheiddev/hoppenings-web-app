  ...
  useEffect(() => {
    async function run() {
      ...
      try {
        ...
        setStatus('error')
        setErrorMessage(e instanceof Error ? e.message : 'Failed to connect Instagram. Please try again.')
      }
    }
        ...
        <div className="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-8 flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            <div
              ...
              style={{ borderColor: Colors.dividerLight, borderTopColor: Colors.primary, animation: 'spin 1s linear infinite' }}
            />
            <div className="text-lg font-bold" style={{ color: Colors.textPrimary, fontFamily: 'var(--font-fjalla-one)' }}>
              Connecting your Instagram…
            </div>
            <div className="text-sm mt-2" style={{ color: Colors.textSecondary, fontFamily: 'var(--font-be-vietnam-pro)' }}>
